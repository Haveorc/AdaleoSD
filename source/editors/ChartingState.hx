...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		'GF Sing',
		'No Animation',
		'Star Note' //Preparations for upcoming full week update
	];
	...
	**/
	...
	override function create()
	{
		...
		{
			_song = {
				song: 'Tutorial', //The dev console would scream at me about missing instrumentals if it was "Test" because "Test" is removed - Haveorc
				notes: [],
				events: [],
				bpm: 120.0,
				needsVoices: true,
	...
	override function update(elapsed:Float)
	{
		...
		if (!blockInput)
		{
			...
			//This is to avoid accidentally sending myself to that menu while I'm testing things in the editor - Haveorc
